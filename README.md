...
The public website for Jared P. Whitehead’s Data-Driven Modeling Group at Brigham Young University. It runs on vinext and is packaged as a Cloudflare Worker.
...
The Research page has a rolling two-year feed for journal articles and arXiv preprints. Run `npm run publications:update` to refresh it from the configured scholarly metadata sources.
